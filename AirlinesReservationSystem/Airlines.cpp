...
public://public member functions
    ...
    int j_detail() // function declaration and definition for domestic journey
    {
        ...
        cout << "*****************************************************************" << endl;
        cout << endl;
        cout << "\1.Banglore(1) \t\2.Delhi(2) \t\3.Pune(3) \t\4.Chennai(4)" << endl << endl;
        cout << "\tEnter Source: ";
        cin >> src;
...
public://public member functions
    ...
    int j_detaili()// function declaration and definition for journey details
    {
        ...
        cout << "*****************************************************************" << endl;
        cout << endl;
        cout << "\1.London(1) \t\2.Dubai(2) \t\3.Abu Dhabi(3) \t\4.Singapore(4) " << endl << endl;
        cout << "\tEnter Source: " ;
        cin >> srci;
        cout << "\tEnter destination: ";
        cin >> desti;
...
public://public member functions
    ...
    {
        cout << "\nGender:\t\tMale-press:1::\t\tFemale-press:2::\n";
...
int main()//main function
{
    ...
    cout << "\n*****************************************************************\n" << endl;
      ...
      {
          case 1://condition
              cout << "\1.Domestic Fights(1) \t\t\t\2.International Flights(2)" << endl;
          ...
          case 2:
              ...
              cout << "\n*****************************************************************\n" << endl;
                  if(ch1==1)
                {
                   cout << "Please enter your PNR Number: ";
                   cin>>n;
